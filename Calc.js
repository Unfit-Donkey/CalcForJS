...
const helpPanel = [
    ...
    {name: "comments", type: 0, content: "Comments are notes that you can place in the history. All comments either start with '//' or '#'. Expressions can also be evaluated within comments using the '$()' synatx. Example: \"// Energy required: $(500[kW]*3[hr])\" will put \"// Energy required: 5400000000[J]\" into the history."},
    ...
    {name: "-parse", type: 1, content: "The <strong>-parse</strong> command returns how the calculator parses an expression. While the majority of the time, -parse returns the same as the input, there are some key differences: \"-parse add(1,2)\" returns \"1+2\", \"-parse 1*2*3\" returns \"(1*2)*3)\". These minor differences may show how a statement is understood when it can otherwise be ambiguous."},
