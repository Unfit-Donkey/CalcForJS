...
const helpPanel = [
    ...
    {name: "mult", type: 2, tags: ["multiply", "product","*"], content: "<strong>mult(a,b)</strong> returns a multiplied by b, equivalent to a*b.<br>Examples<ul><li><syntax>3*4</syntax> = 12</li><li><syntax>&lt;1,2,3&gt;*3</syntax> = <syntax>&lt;2,4,6&gt;</syntax></li><li><syntax>&lt;1,2;4,3&gt;*&lt;4,3,2&gt;</syntax> = <syntax>&lt;4,6&gt;</syntax></li></ul> For matrix multiplication (opposed to vector multiplication), use the <help><syntax>mat_mult</syntax></help> function.", arguments: ["a", "b"]},
